...
<html lang="en">
  <head>
    ...
    <!-- Primary Meta Tags -->
    <meta name="title" content="Controller">
    <meta name="description" content="Control your guilds.">
    ...
    <meta property="og:description" content="Control your guilds.">
    ...
    <meta property="twitter:description" content="Control your guilds.">
      ...
      <div class="contentPane" style="background: url('https://artemis.rest/img.d/tree4t.png') no-repeat bottom right; background-size: 95vh;">
        <div class="cPaneTop">
          ...
          <div style="display: flex; filter: grayscale(0%);">
            / <a href="index.php">home</a> / <a href="control.d.php" style="text-decoration: underline;">here</a>
          </div>
          <div style="font-size: 3em; place-items: center end; padding-right: 1vh;">Controller</div>
        </div>
        <div class="cPaneMain">
          <?php echo $controlContent; ?>
          <br />
        </div>
      </div>
    </div>
