<?php
  ...
  if(!$testTableThree) $connection->query("CREATE TABLE User (id varchar(100) NOT NULL, username varchar(255), discriminator varchar(255), avatar varchar(255), points int, PRIMARY KEY (id))");
